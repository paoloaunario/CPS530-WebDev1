<?php
// source: /hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/config/config.neon 
// source: /hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/config/config.local.neon 

class Container_6a3d1148cd extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app',
			'wwwDir' => '/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => '/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/../temp',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_6a3d1148cd $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/hermes/bosnacweb02/bosnacweb02bh/b1752/ipg.mishelsartcom/nette/sandbox/app/../temp/cache/latte');
